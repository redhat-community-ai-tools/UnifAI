...
class GraphNodeActivities:
    ...
    def execute_node(self, params: ExecuteNodeParams) -> GraphState:
        from global_utils.utils.logging_config import set_request_id, set_session_id
        if params.request_id:
            set_request_id(params.request_id)
        if params.session_id:
            set_session_id(params.session_id)
    ...
    def evaluate_condition(self, params: EvaluateConditionParams) -> str:
        from global_utils.utils.logging_config import set_request_id
        if params.request_id:
            set_request_id(params.request_id)

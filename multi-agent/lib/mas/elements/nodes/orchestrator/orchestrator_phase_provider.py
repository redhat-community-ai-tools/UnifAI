    ...
    def _create_phase_system(self) -> PhaseSystem:
        ...
        allocation_phase = PhaseDefinition(
            ...
            guidance=(
                ...
                "- If the cycle context above lists FILE ATTACHMENTS, you MUST explicitly instruct each delegated agent to read the relevant file(s)\n"
                "- Include in delegation content: 'First, use the read_attached_file tool to review [filename], then proceed with...'\n"
                "- Match files to agents by relevance (e.g. sre_guidelines.pdf -> SRE agent, plm_guidelines.pdf -> PLM agent)\n"
                "- Agents will NOT read files unless you tell them to — do NOT skip this step\n\n"
                "IMPORTANT:\n"

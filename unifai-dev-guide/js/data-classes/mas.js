  ...
  layers: [
    ...
    },
    {
      ...
      classes: [
        ...
        { name: 'BaseNode', file: 'lib/mas/elements/nodes/common/base_node.py', role: 'Wraps GraphState in permission-scoped StateView, calls run(). Channels via MRO.', calls: ['StateView'], calledBy: ['CustomAgentNode', 'OrchestratorNode', 'A2AAgentNode', 'UserQuestionNode', 'FinalAnswerNode', 'MergerNode', 'BranchChooserNode'] },

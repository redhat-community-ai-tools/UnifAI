SERVICES.rag = {
  ...
  _endpoints: [
    ...
    { method: 'DELETE', path: '/data_sources/data.source.delete', summary: 'delete + vector cleanup', group: 'Data Sources' },
    ...
    { method: 'GET', path: '/terms_approval/user.approval.status.get', summary: 'check user transparency notice approval', group: 'Terms Approval' },
    { method: 'POST', path: '/terms_approval/user.approval.record.post', summary: 'record user transparency notice approval', group: 'Terms Approval' },
    ...
    { method: 'GET', path: '/health/version', summary: 'build version info', group: 'Settings & Health' },
